...
if __name__ == "__main__":
    ...
    output_image = 'C:\\CODE\\Output\\mapped_Water_output_VzwPrimary.png'
    template_path = 'C:\\CODE\\Template\\QGIS-WaterCoverage-Style.qml'
    qml_paths = ['C:\\CODE\\Template\\QGIS-SecondaryCoverage_Vzw-Primary-Style.qml', 'C:\\CODE\\Template\\QGIS-WaterCoverageBlue-Style.qml']
    value_fields = ['Primary Vzw', 'Vzw Primary']
    filter_expressions = ["Primary Vzw = 'ATT'", "Vzw Primary = 'Vzw'"]
